...
export const codeUserValidation = body('code')
    .notEmpty()
    .withMessage(usersErrorsValidator.codeError.message)
    .isString()
    .withMessage(usersErrorsValidator.codeError.message)
    .trim()
    .withMessage(usersErrorsValidator.codeError.message)
...
export const recoveryCodeUserValidation = body('recoveryCode')
    .notEmpty()
    .withMessage(usersErrorsValidator.recoveryCodeError.message)
    .isString()
    .withMessage(usersErrorsValidator.recoveryCodeError.message)
    .trim()
    .withMessage(usersErrorsValidator.recoveryCodeError.message)
